...
10) a .py file that establishes a custom .json parser for the user to implement (libraries used: json, textquisite, collections, sentiment_nltk)
...
1) a .mp4 file representative of a walkthrough of the code for the project
2) a .pdf representative of the final poster for the project
